...
var AuthRouterModule = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, user_service_1.default.getByEmail(email)];
                    case 2:
                        user = _b.sent();
                        console.log(user);
                        return [2 /*return*/, response_handlers_1.default.authSuccess(res, password, user)];
                    case 3:
                        error_1 = _b.sent();
                        return [2 /*return*/, response_handlers_1.default.authFail(req, res)];
                    case 4: return [3 /*break*/, 6];
                    case 5: return [2 /*return*/, response_handlers_1.default.onError(res, 'Necessário informar email e senha!', 'no-credentials')];
